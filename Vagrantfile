...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mruckman-train-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/mruckman-train"
  #   chef.validation_client_name = "mruckman-train-validator"
  #   chef.validation_key_path = ".chef/mruckman-train-validator.pem"
  # end
end
